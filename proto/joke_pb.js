...
proto.JokesReply = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.JokesReply.repeatedFields_, null);
};
...
proto.JokesReply.toObject = function(includeInstance, msg) {
  var f, obj = {
    jokesList: jspb.Message.toObjectList(msg.getJokesList(),
    proto.Joke.toObject, includeInstance)
  };
...
proto.JokesReply.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.Joke.serializeBinaryToWriter
    );
  }
};
...
proto.JokesReply.prototype.getJokesList = function() {
  return /** @type{!Array<!proto.Joke>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.Joke, 1));
};
...
proto.JokesReply.prototype.addJokes = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.Joke, opt_index);
};
